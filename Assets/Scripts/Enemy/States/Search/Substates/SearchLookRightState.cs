...
public class SearchLookRightState : EnemyState {

    private float lookingDuration = 1.5f;
    private float timeRemaining;
    private bool timerIsRunning = false;

    public SearchLookRightState(EnemyAI enemy, EnemyStateMachine enemyStateMachine) : base(enemy, enemyStateMachine) {}
